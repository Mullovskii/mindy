...
class FavorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favor" do
    assert_difference('Favor.count') do
      post favors_url, params: { favor: { field_id: @favor.field_id, section_id: @favor.section_id, user_id: @favor.user_id } }
    end
  ...
  test "should update favor" do
    patch favor_url(@favor), params: { favor: { field_id: @favor.field_id, section_id: @favor.section_id, user_id: @favor.user_id } }
